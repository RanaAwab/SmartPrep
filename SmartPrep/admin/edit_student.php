...
// Fetch student
$student = fetch("SELECT * FROM users WHERE id = ? AND role = 'student'", [$id]);
...
<div class="form-card">
    <h2 class="dash-title">Edit Student</h2>
    ...
    <form method="POST">
        ...
        <div class="text-center mt-2">
            <button class="btn-save w-100">Update Student Account</button>
        </div>
    </form>
</div>
