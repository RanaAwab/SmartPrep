...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    elseif (strlen($code) < 2) {
        ...
        $existing = fetch("SELECT id FROM courses WHERE code = ?", [$code]);
...
<div class="form-card">
    <h2 class="dash-title">Add Course</h2>
    ...
    <form method="POST">
        <div class="mb-4">
            ...
            <input type="text" name="name" class="form-control-custom" placeholder="e.g. Master of Software Engineering" required>
        </div>

        <div class="mb-4">
            <label class="form-label-custom">Course Code</label>
            <input type="text" name="code" class="form-control-custom" placeholder="e.g. MSE500" required>
        </div>

        <div class="text-center">
            <button class="btn-save w-100">Create Course</button>
        </div>
    </form>
</div>
