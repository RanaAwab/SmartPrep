...
<a href="manage_students.php" class="page-top-link">
    <i class="bi bi-arrow-left"></i> Back to Students
</a>

<div class="form-card">
    <h2 class="dash-title">Add Student</h2>
    ...
    <form method="POST">
        <div class="mb-4">
            ...
            <div class="input-with-icon">
                ...
                <input type="text" name="name" class="form-control-custom" placeholder="e.g. Jane Smith" required>
            </div>
        </div>
        ...
        <div class="mb-4">
            ...
            <div class="input-with-icon">
                ...
                <input type="email" name="email" class="form-control-custom" placeholder="e.g. jane@smartprep.edu" required>
            </div>
        </div>
        ...
        <div class="text-center mt-2">
            <button class="btn-save w-100">Create Student Account</button>
        </div>
    </form>
</div>
