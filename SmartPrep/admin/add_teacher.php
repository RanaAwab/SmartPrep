...
<div class="form-card">
    <h2 class="dash-title">Add Teacher</h2>
    ...
    <form method="POST">
        <div class="mb-4">
            ...
            <div class="input-with-icon">
                ...
                <input type="text" name="name" class="form-control-custom" placeholder="e.g. John Doe" required>
            </div>
        </div>
        ...
        <div class="mb-4">
            ...
            <div class="input-with-icon">
                ...
                <input type="email" name="email" class="form-control-custom" placeholder="e.g. john@smartprep.edu" required>
            </div>
        </div>
        ...
        <div class="text-center mt-2">
            <button class="btn-save w-100">Create Teacher Account</button>
        </div>
    </form>
</div>
